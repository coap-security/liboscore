...
#[no_mangle]
pub extern "C" fn oscore_crypto_aead_from_number(
...
#[no_mangle]
pub extern "C" fn oscore_crypto_aead_get_number(
    alg: Algorithm,
...
#[no_mangle]
pub extern "C" fn oscore_crypto_aead_from_string(
...
#[no_mangle]
pub extern "C" fn oscore_crypto_aead_get_taglength(alg: Algorithm) -> usize {
    alg.tag_length()
}

#[no_mangle]
pub extern "C" fn oscore_crypto_aead_get_ivlength(alg: Algorithm) -> usize {
    alg.iv_length()
}

#[no_mangle]
pub extern "C" fn oscore_crypto_aead_get_keylength(alg: Algorithm) -> usize {
    alg.key_length()
}

#[no_mangle]
pub extern "C" fn oscore_crypto_aead_encrypt_start(
...
#[no_mangle]
pub extern "C" fn oscore_crypto_aead_encrypt_feed_aad(
    state: *mut c_void,
    aad_chunk: *const u8,
    aad_chunk_len: usize,
) -> CryptoErr {
...
#[no_mangle]
pub extern "C" fn oscore_crypto_aead_encrypt_inplace(
...
#[no_mangle]
pub extern "C" fn oscore_crypto_aead_decrypt_start(
...
#[no_mangle]
pub extern "C" fn oscore_crypto_aead_decrypt_feed_aad(
    state: *mut c_void,
    aad_chunk: *const u8,
    aad_chunk_len: usize,
) -> CryptoErr {
...
#[no_mangle]
pub extern "C" fn oscore_crypto_aead_decrypt_inplace(
